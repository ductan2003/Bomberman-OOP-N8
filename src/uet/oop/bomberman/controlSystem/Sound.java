...
public class Sound {
    ...
    public static SoundPlay putBomb = new SoundPlay("res\\sound\\putBomb.wav");
    public static SoundPlay win = new SoundPlay("res\\sound\\win.wav");
    public static SoundPlay backgroundGame = new SoundPlay("res\\sound\\background.wav");
    public static SoundPlay playGame = new SoundPlay("res\\sound\\playgame1.mid");
